...
<section
	...
	<div class="__wrapper c-main relative">
		<h2 data-gsap-element="header" class="__header w-full text-primary md:w-1/2 mb-8">{{ $g_logos['header'] }}</h2>
	</div>
	@endif
	...
	<div class="relative w-full overflow-hidden my-6">
		...
		<div class="flex w-max items-center animate-infinite-scroll py-2">
			...
			@for ($copy = 0; $copy < 4; $copy++)
				...
				<div class="bg-white flex items-center justify-center p-4 rounded-2xl shadow-sm w-56 h-24 shrink-0 mr-8" @if($copy> 0) aria-hidden="true" @endif>
