...
<section
	...
	<div class="__wrapper c-main">
		<div class="__content">
			@if(!empty($header))
			<div data-gsap-element="header" class="__wrapper text-primary block w-full md:w-1/2">
				<h3 class="">{{ $header }}</h3>
			</div>
			@endif
			...
			<div class="swiper reviews-swiper !overflow-visible">
				...
				<div data-gsap-element="arrows" class="w-full z-10 flex flex-col md:flex-row items-center pointer-events-none gap-4 mt-10">
					<div class="flex items-center pointer-events-none gap-4 order-2 md:order-1">
						<div class="__prev rounded-full bg-primary hover:bg-primary-hover h-14 w-14 flex items-center justify-center pointer-events-auto cursor-pointer transition-all duration-400 shrink-0">
						...
						<div class="__next rounded-full bg-primary hover:bg-primary-hover h-14 w-14 flex items-center justify-center pointer-events-auto cursor-pointer transition-all duration-300 shrink-0">
							<svg xmlns="http://www.w3.org/2000/svg" width="13" height="12" viewBox="0 0 13 12" fill="none">
